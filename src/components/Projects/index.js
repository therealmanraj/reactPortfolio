      ...
      <Wrapper>
        ...
        <ToggleButtonGroup >
          ...
          {toggle === 'research paper' ?
            <ToggleButton active value="research paper" onClick={() => setToggle('research paper')}>RESEARCH PAPER</ToggleButton>
            :
            <ToggleButton value="research paper" onClick={() => setToggle('research paper')}>RESEARCH PAPER</ToggleButton>
          }
        </ToggleButtonGroup>
        <CardContainer>
          {toggle === 'all' && projects
